...
var ModelViewer = function ModelViewer(_ref) {
  var modelLink = _ref.modelLink,
  ...
  useEffect(function () {
    if (WebGL.isWebGLAvailable()) {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 9:
                ...
                console.error("An error occurred while loading the model", _context.t0);
              case 12:
              case "end":
      ...
      return function () {
        ...
        mountRef === null || mountRef === void 0 || (_mountRef$current = mountRef.current) === null || _mountRef$current === void 0 || _mountRef$current.removeChild(renderer === null || renderer === void 0 ? void 0 : renderer.domElement);
      };
    } else {
